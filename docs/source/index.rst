...
Latest stable release is v1.7 (:doc:`Changelog <changes>`)
...
This library has been specially designed for people and organizations don't want to import the whole `DigitalSide Threat-Intel <https://osint.digitalside.it>`_ dataset and prefer to use it as on demand service.
